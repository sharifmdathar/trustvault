...
import { getUserVaults, confirmVault, flagDispute } from '../../src/utils/stellar.js';
...
export default function Page() {
  ...
  const handleDispute = async (vaultId: string) => {
    const confirmed = confirm('Are you sure you want to dispute this transaction?');
    if (!confirmed) return;
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-6">Connect your wallet to view your vaults</p>
